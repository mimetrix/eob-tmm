...
| [`explainers/`](explainers/) | Visual explainers (HTML). [`programmable-dataplane-engine-v1.html`](explainers/programmable-dataplane-engine-v1.html) — the full programmable-data-plane story (engine + shield + data intelligence, one flow); [`programmable-dataplane-engine-v2.html`](explainers/programmable-dataplane-engine-v2.html) — the **pure engine** (the generic verified-eBPF utility, no application-specific framing); [`cve-mitigation.html`](explainers/cve-mitigation.html) — a plain-language explainer of data-plane CVE mitigation (the shield); [`data-intelligence.html`](explainers/data-intelligence.html) — the data-plane-intelligence architecture (mechanism, API-discovery MVP reference design, the learn tier) |
