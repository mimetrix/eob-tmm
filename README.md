...
| [`explainers/`](explainers/) | Visual explainers (HTML). [`programmable-dataplane-engine-v1.html`](explainers/programmable-dataplane-engine-v1.html) — the programmable-data-plane story (substrate mechanism, shield, tracepoints); [`data-intelligence.html`](explainers/data-intelligence.html) — the data-plane-intelligence architecture (mechanism, API-discovery MVP reference design, the learn tier); [`one-pager.html`](explainers/one-pager.html) — the print one-pager |
