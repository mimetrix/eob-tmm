...
| [`engine-hard-problems.html`](engine-hard-problems.html) | The engineering register — time safety, the `ctx` ABI, shared state, the trust surface, ten further concerns, day-one vs. deferred sequencing, honest scope | 20 min |
