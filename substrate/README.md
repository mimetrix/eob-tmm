...
The per-item code skeletons that *used* the proposed ABI were retired 2026-08-26; the working
in-TMM sources above supersede them.
...
are: they are compiled into TMM and they do execute a shield.
