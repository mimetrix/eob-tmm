...
/* Hook and schema identity live in ls_tp.h --- they are part of the
 * ls_tp_dispatch() contract, and the trampoline needs them without
 * dragging mmap and stdatomic in. */
